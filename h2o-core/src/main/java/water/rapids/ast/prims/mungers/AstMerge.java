...
/*      if (allRite)
      ...
      // TODO: re-order columns for allRite, do it before submitting PR, refer to moveFirst
      return onlyLeftAllOff?sortingMerge(l, r, allLeft, allRite, ncols, id_maps):sortingMerge(r,l,allRite,allLeft, ncols, id_maps);
    }
